...
export function ProductCard({ product }: { product: Product }) {
  return (
    <Link
      ...
      className="group block bg-brand-black-2 border border-brand-border hover:border-brand-red rounded-sm overflow-hidden"
    >
      ...
      <div className="p-4">
        <h3 className="font-display uppercase text-sm leading-tight mb-1">{product.name}</h3>
